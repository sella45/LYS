...
// react에서는 react-cookie 패키지를 이용해서 조금 더 수월하게 cookie를 다룰 수 있음
// cookie 설정, 검색, 삭제를 간단한 함수만으로 잒업할 수 있음 
...
export default function Cookie() {
    ...
    // useCookies: react에서 쿠기 객체, 쿠키 변경 함수, 쿠키 제거 함수를 배열로 반환하는 react-cookie의 훅 함수 
