...
/*
    - for-in 방식은 index를 사용하여 한번 더 접근을 해야하기 떄문에 단순히 읽는 작업에 대해서는 적합하지 않을 수 있음
...
/*
    indexOf(element) : 
    - 배열에 매개변수로 전달한 요소가 존재한다면 첫 번째 인덱스 값을 반환
    - 존재하지 않으면 -1을 반환
*/
...
/*
    slice(start, end) : 
    - start에 해당하는 인덱스부터 end에 해당하는 인덱스 까지 복사하여 반환
*/
...
/*
    ...
    - 배열의 요소를 재거하고 제거한 위치에 요소를 갈아끼운 배열을 반환 
*/
console.log(numbers.splice(1, 2, '추가', '추가2'),numbers); // 인덱스 1부터 2개 제거하고 '추가'를 새로운 배열에 추가
console.log(numbers.splice(1, 1), numbers); // 인덱스 1부터 1개 제거하고 새로운 배열에 추가
